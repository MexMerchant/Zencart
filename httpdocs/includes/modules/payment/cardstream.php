...
//        $this->secret = 'Threeds2Test60System';
    ...
    function selection() {
        if (MODULE_PAYMENT_CARDSTREAM_CAPTURE_TYPE == 'Direct' || MODULE_PAYMENT_CARDSTREAM_CAPTURE_TYPE == 'Direct V2') {
    ...
    function process_button() {
        switch (MODULE_PAYMENT_CARDSTREAM_CAPTURE_TYPE) {
            case 'Hosted':
            case 'Modal':
...
//            "formResponsive"    => MODULE_PAYMENT_CARDSTREAM_RESPONSIVE_TYPE == 'True' ? 'Y' : 'N',
    ...
    function before_process() {
        ...
        if (MODULE_PAYMENT_CARDSTREAM_CAPTURE_TYPE == 'Hosted' || MODULE_PAYMENT_CARDSTREAM_CAPTURE_TYPE == 'Modal') {
...
HTML;
    ...
    function valid_setup() {
        ...
        return ($isEnabled && in_array(MODULE_PAYMENT_CARDSTREAM_CAPTURE_TYPE, array('Direct', 'Direct V2'), true) && $this->is_https() || $isEnabled && in_array(MODULE_PAYMENT_CARDSTREAM_CAPTURE_TYPE, array('Hosted', 'Modal'), true));
    }
    /*
    ...
    function form_url() {
        switch (MODULE_PAYMENT_CARDSTREAM_CAPTURE_TYPE) {
            ...
            case 'Modal':
                return MODULE_PAYMENT_CARDSTREAM_MODAL_URL;
            case 'Direct':
            case 'Direct V2':
